...
export default class ManageClient extends React.Component {
    ...
    // loadData url: 'http://talentserviceprofile.azurewebsites.net/profile/profile/getClientList',
    //deleteClient  url: 'http://talentidentityservices.azurewebsites.net/authentication/authentication/deactivateClientAccount?id=' + clientId,
